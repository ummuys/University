...
QString Window_BubbleSort::get_adress_f(){
    return adress_f;
}
QString Window_BubbleSort::get_adress_s(){
    return adress_s;
}
bool Window_BubbleSort::get_is_admin(){
    return admin_file;
}
...
void Window_BubbleSort::on_pushButton_3_clicked(){
    ...
    if(!adress_s.isEmpty() && !adress_f.isEmpty()){my_sorts(2,adress_f,adress_s, admin_file);}
